...
import { Navbar, Sidebar, OpenClose } from '../../index.js'
...
},
{
  ...
  return (
    <div className='bg-bg bg-center font-Roboto-Flex bg-cover min-h-screen w-screen overflow-x-hidden  h-screen relative'>
    <Sidebar />

...
const Sidebar = () => {
    ...
    return (
        <div className='font-Roboto-Flex'>
            ...
            <div className='sidebar z-50  fixed top-0 bottom-0 lg:left-0 left-[-280px] py-2 w-[280px] overflow-y-hidden text-center  overflow-x-hidden bg-primary_grey flex flex-col h-full '>
                ...
                <div className=' mt-3 flex pr-6 items-center rounded-md  duration-300 cursor-pointer text-white'>
                    <div className={`flex items-center  py-2.5   rounded-r-full ${activeTab === 1 ? 'bg-primary_gold' : ''
                        }  w-full h-full`
                    }
    ...
    .sidebar::after {
      ...
      height: 100%;
      width: 2.5px; /* Adjust width of the divider */
